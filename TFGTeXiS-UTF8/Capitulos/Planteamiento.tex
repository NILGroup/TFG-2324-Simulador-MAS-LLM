...
Para acotar un poco lo que entendemos por tiempo razonable, nos basta con aproximar la cantidad de tokens de entrada al LLM que se realizan por \textit{timestep} por cada personaje
