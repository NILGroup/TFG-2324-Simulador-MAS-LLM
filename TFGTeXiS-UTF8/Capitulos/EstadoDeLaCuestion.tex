...
La comunicación con el LLM es central en este trabajo, se trata del motor que lleva acabo toda la simulación. El enfoque que se dió desde \ga \citep{park2023generative}, la mayor preocupación fué obtener respuestas acordes a las estructuras esperadas. Por ello nos encontramos con una estructura algo enrevesada que involucra funciones de orden superior.
...
\textit{reverie/backend\_server/persona/prompt\_template/templates/gpt\_structure.py} contiene todas las llamadas a esas funciones, donde habrá una función por cada tipo de petición que se haga al LLM. Cada una de estas funciones define su respuesta por defecto, el tipo de respuesta esperada y la información estrictamente necesaria con la que se queda.
